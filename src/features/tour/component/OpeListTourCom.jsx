            ...
            <div className="tab-pane fade active show" id="Hotels-list">
                <div className="card border-0">
                    <div className="card-body d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                        <div>
                            <h5 className="mb-1">Danh sách tour</h5>
                            <p>Tổng số: {totalItems}</p>
                        </div>
                        <div>
                            <a href="/tour/create" className="btn btn-primary d-inline-flex align-items-center me-0"><FaPlus className="me-1 fs-16" />Thêm tour</a>
                        </div>
                    </div>
                </div>
                        ...
                        {!loading && totalItems > 0 && (
                            <div className="d-flex justify-content-between align-items-center mb-3">
                                <div className="d-flex align-items-center">
                                    <span className="me-2">Số dòng/trang:</span>
                                    <select
                                ...
                                <div className="text-muted">
                                    Hiển thị {getDisplayInfo().startItem} đến {getDisplayInfo().endItem} trên tổng {totalItems} tour
                                </div>
                            </div>
                        )}
