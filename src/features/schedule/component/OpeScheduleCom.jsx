        ...
        <div className="col-xl-9 col-lg-8 theiaStickySidebar">
            ...
            <div className="card booking-header border-0">
                <div className="card-body header-content d-flex align-items-center justify-content-between flex-wrap ">
                    <div>
                        <h6 className="mb-1">Schedules</h6>
                        <p className="fs-14 text-gray-6 fw-normal ">Total : {filterList.length}</p>
                    </div>
                ...
                <div className="card-body p-0">
                    <div className="list-header d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div className="d-flex align-items-center flex-wrap">
                            ...
                            {/* <div className="dropdown me-3">
                                        <select className="form-select form-select-sm" aria-label=".form-select-sm example" onChange={handleFilterChange}>
                            ...
                            <div className="modal-dialog  modal-dialog-centered modal-xl">
                                <div className="modal-content">
                                        ...
                                        <div className="upcoming-content">
                                            ...
                                            <div className="upcoming-details">
                                                ...
                                                {date.tourGuides.length === 0 ? (
                                                    <p className="text-gray-6 fs-16">No tour guides available</p>
                                                ) : (
                                    ...
                                    <div className="modal-footer">
                                        {!date.isCancelDate ? (
                                            <a className="btn btn-md btn-danger" data-bs-dismiss="modal" onClick={(e) => { handleCancel(date.id) }}>Cancel</a>
                                        ) : (
                                            <a className="btn btn-md btn-info" data-bs-dismiss="modal" >Close</a>
                                        )}
                                    </div>
