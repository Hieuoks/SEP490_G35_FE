                        ...
                        <div class="card payment-details">
                            ...
                            <div class="card-body">
                                ...
                                <div class="credit-card-details ">
                                    <div class="mb-3">
                                        <h6 class="fs-16 ">Payment With QR Code</h6>
                                    </div>
                                    ...
                                    <div class="card-form ">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 border-bottom mb-3">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <h6 class="fs-16">Year</h6>
                                                        <p class="fs-16">
                                                            <select defaultValue={1} class="form-select form-select-sm" onChange={(e) => {
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <h6 class="fs-16">Price per year </h6>
                                                        <p class="fs-16">{packagesRes.price === 0 ? "Free" : `${formatPrice(packagesRes.price)}`}</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6 ">
                                                <div class="mb-3">
                                                    <h6>Amount to Pay</h6>
                                                    <h6 class="text-primary">{formatPrice(packagesRes.price * number)}</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 ">
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center justify-content-end flex-wrap gap-2">
                                                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#booking-success" onClick={() => {
                            ...
                            <div class="card-body">
                                <div class="pb-3 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h6 class="mb-2">{packagesRes.name}</h6>
                                        <h6 class="mb-2">{packagesRes.price === 0 ? "Free" : `${formatPrice(packagesRes.price)}/year`}</h6>
                                    </div>
                                </div>
                                <div class="mt-3 pb-3 border-bottom">
                                    <h6 class="text-primary mb-3">Package Info</h6>
                                    <div class="d-flex align-items-center details-info">
                                        <FaCheckCircle className="text-success me-1" />
                                        Have {packagesRes.maxTour===0?"Infinity":packagesRes.maxTour} tours per months
                                    </div>
                                    <div class="d-flex align-items-center  details-info">
                                        <FaCheckCircle className="text-success me-1" />
                                        Have {packagesRes.maxImage===0?"Infinity":packagesRes.maxImage} images per tours
                                    </div>
                                    <div class="d-flex align-items-center details-info">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="payment-info">
                                            ...
                                            <div className="transfer-details">
                                                ...
                                                <div className="detail-item mb-3">
                                                    <label className="form-label fw-medium">Holder:</label>
                                                ...
                                                <div className="detail-item mb-4">
                                                    <h6 className="form-label fw-medium">Amount:</h6>
                                                    <h6 className="fs-16">{packagesRes.price * number} VND</h6>
                                                </div>

                                                <div className="alert alert-info">
                                                    <i className="fas fa-info-circle me-2"></i>
                                                    <strong>Note:</strong> Please do not add, edit or delete content or amount after scanning QR
                                                </div>
                                    ...
                                    <div className="col-lg-6">
                                        <div className="qr-code-section text-center">
                                            ...
                                            <div className="qr-instructions">
                                                <h6 className="mb-3">How to pay with QR Code:</h6>
                                                <div className="steps">
                                                    ...
                                                    <div className="step-item d-flex align-items-center mb-2">
                                                        ...
                                                        <span>Select QR code scanning feature</span>
                                                    </div>
                                                    <div className="step-item d-flex align-items-center mb-2">
                                                        <div className="step-number bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-3" style={{ width: '25px', height: '25px', fontSize: '12px' }}>
                                                            3
                                                        </div>
                                                        <span>Scan the QR code next to it</span>
                                                    </div>
                                            ...
                                            <div className="mt-4">
                                                <div className="alert alert-warning">
                                                    ...
                                                    <strong>Note:</strong> Make sure the transfer content is correct.
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-end flex-wrap gap-2">
                                                <a href="/operator/package" class="btn btn-primary" > Done </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
